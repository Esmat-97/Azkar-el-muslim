...
$response ='{
    ...
    "content": [
        ...
        {
            "zekr": "اللّهُـمَّ إِنِّـي أَمسيت أُشْـهِدُك ، وَأُشْـهِدُ حَمَلَـةَ عَـرْشِـك ، وَمَلَائِكَتَكَ ، وَجَمـيعَ خَلْـقِك ، أَنَّـكَ أَنْـتَ اللهُ لا إلهَ إلاّ أَنْـتَ وَحْـدَكَ لا شَريكَ لَـك ، وَأَنَّ ُ مُحَمّـداً عَبْـدُكَ وَرَسـولُـك.",
            "repeat": 4,
            "bless": "من قالها أعتقه الله من النار."
        },
        {
            "zekr": "اللّهُـمَّ ما أَمسي بي مِـنْ نِعْـمَةٍ أَو بِأَحَـدٍ مِـنْ خَلْـقِك ، فَمِـنْكَ وَحْـدَكَ لا شريكَ لَـك ، فَلَـكَ الْحَمْـدُ وَلَـكَ الشُّكْـر.",
            "repeat": 1,
        ...
        {
            "zekr": "اللّهُـمَّ بِكَ أَمسينا وَبِكَ أَصبحنا ، وَبِكَ نَحْـيا وَبِكَ نَمُـوتُ وَإِلَـيْكَ النُّـشُور.",
            "repeat": 1,
            "bless": ""
        },
        {
        ...
        {
            "zekr": "أَمسينا و امسي المُـلكُ للهِ رَبِّ العـالَمـين ، اللّهُـمَّ إِنِّـي أسْـأَلُـكَ خَـيْرَ هـذا الـيَوْم ، فَـتْحَهُ ، وَنَصْـرَهُ ، وَنـورَهُ وَبَـرَكَتَـهُ ، وَهُـداهُ ، وَأَعـوذُ بِـكَ مِـنْ شَـرِّ ما فـيهِ وَشَـرِّ ما بَعْـدَه.",
            "repeat": 1,
            "bless": ""
        },
        {
            ...
            echo '
                <div class="container">
                    <div class="azkar-item">
                        <p class="azkar-text">' . htmlspecialchars($item['zekr']) . '</p>
                        <div class="azkar-text">تكرار: ' . htmlspecialchars($item['repeat']) . '</div>
                        <div class="azkar-text">' . htmlspecialchars($item['bless']) . '</div>
                    </div>
                </div>
            ';
        }
